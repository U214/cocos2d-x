...
void HelloWorld::setBox2dWorld() {
	...
	b2Body *body0, *body1, *body2;

	body0 = this->addNewSprite(Vec2(240, 160), Size(160, 60), b2_staticBody, NULL, 0);
	body1 = this->addNewSprite(Vec2(240-40, 160), Size(40, 40), b2_dynamicBody, NULL, 1);
	body2 = this->addNewSprite(Vec2(240+20, 160), Size(80, 80), b2_dynamicBody, NULL, 1);
	...
	// joint1 생성 전에 위 모터의 속성들이 정의되어야 한다
