...
void JControlManager::Initialize(Scene *scene)
{
    btnSpr_[UP] = CEntity::create(scene, NULL, "Joystick/button_a.png", Vec2(400, 60));
    btnSpr_[DOWN] = CEntity::create(scene, NULL, "Joystick/button_pushed_a.png", Vec2(400, 60));
	btnSpr_[DOWN]->setVisible(false);
	
    joypad_ = CEntity::create(scene, NULL, "Joystick/joypad.png", Vec2(64, 64));
    joypadCap_ = CEntity::create(scene, NULL, "Joystick/joypadCap.png", Vec2(64, 64));
