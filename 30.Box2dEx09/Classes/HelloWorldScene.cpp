...
void HelloWorld::setBox2dWorld() {
	...
	body1 = this->addNewSprite(Vec2(240, 280), Size(40, 40), b2_dynamicBody, "test", 0);
	body2 = this->addNewSprite(Vec2(340, 280), Size(40, 40), b2_dynamicBody, "test", 0);

	disJointDef.Initialize(body1, body2, body1->GetPosition(), body2->GetPosition());
	
	_world->CreateJoint(&disJointDef);
}
