...
bool HelloWorld::init()
{
	...
	auto pMenuItem1A = MenuItemFont::create("Preload All", CC_CALLBACK_1
	(HelloWorld::preloadAll, this));
	auto pMenuItem1B = MenuItemFont::create("Uncache All", CC_CALLBACK_1
	(HelloWorld::uncacheAll, this));

	auto pMenuItem1C = MenuItemFont::create("Volume Up", CC_CALLBACK_1
	(HelloWorld::upVolume, this));
	auto pMenuItem1D = MenuItemFont::create("Volume Down", CC_CALLBACK_1
	(HelloWorld::downVolume, this));

	pMenuItem1A->setColor(Color3B::BLACK);
	pMenuItem1B->setColor(Color3B::BLACK);
	pMenuItem1C->setColor(Color3B::BLACK);
	pMenuItem1D->setColor(Color3B::BLACK);
	...
	auto pMenuItem2A = MenuItemFont::create("Play Sound1", CC_CALLBACK_1
	(HelloWorld::playSound1, this));
	auto pMenuItem2B = MenuItemFont::create("Pause Sound1", CC_CALLBACK_1
	(HelloWorld::pauseSound1, this));

	auto pMenuItem2C = MenuItemFont::create("Resume Sound1", CC_CALLBACK_1
	(HelloWorld::resumeSound1, this));
	auto pMenuItem2D = MenuItemFont::create("Stop Sound1", CC_CALLBACK_1
	(HelloWorld::stopSound1, this));

	pMenuItem2A->setColor(Color3B::BLACK);
	pMenuItem2B->setColor(Color3B::BLACK);
	pMenuItem2C->setColor(Color3B::BLACK);
	pMenuItem2D->setColor(Color3B::BLACK);
	...
	auto pMenuItem3A = MenuItemFont::create("Play Sound2", CC_CALLBACK_1
	(HelloWorld::playSound2, this));
	auto pMenuItem3B = MenuItemFont::create("Pause Sound2", CC_CALLBACK_1
	(HelloWorld::pauseSound2, this));

	auto pMenuItem3C = MenuItemFont::create("Resume Sound2", CC_CALLBACK_1
	(HelloWorld::resumeSound2, this));
	auto pMenuItem3D = MenuItemFont::create("Stop Sound2", CC_CALLBACK_1
	(HelloWorld::stopSound2, this));

	pMenuItem3A->setColor(Color3B::BLACK);
	pMenuItem3B->setColor(Color3B::BLACK);
	pMenuItem3C->setColor(Color3B::BLACK);
	pMenuItem3D->setColor(Color3B::BLACK);
...
void HelloWorld::upVolume(Ref* pSender) {
	if (_soundVolume < 1.0f) {
		_soundVolume = _soundVolume + 0.1f; // 10%씩 조절
	}
...
void HelloWorld::playSound2(Ref* pSender) {
	if (AudioEngine::getState(audioId2) != AudioEngine::AudioState::PLAYING) {
		audioId2 = AudioEngine::play2d(BGM_1_PATH, true, _soundVolume);

		if (audioId2 != AudioEngine::INVALID_AUDIO_ID) {
			AudioEngine::setFinishCallback(audioId2, CC_CALLBACK_2(
				HelloWorld::bgmPlayFinishedCallback, this));
		}
	}
}
